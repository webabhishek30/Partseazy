...
public class ImageRequest extends Request<Bitmap> {
    ...
    protected Response<Bitmap> parseNetworkResponseUnpacked(NetworkResponse response) {
        ...
        synchronized (sDecodeLock) {
            try {
                ...
                VolleyLog.e("Caught OOM for %d byte image, url=%s", response.processedData.length, getUrl());
    ...
    @Override
    protected void deliverResponse(Request<Bitmap> request, Bitmap response, Response<Bitmap> fullResponse) {
