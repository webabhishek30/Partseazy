...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        ...
        if(gzipEnabled){
            try {
                ...
                e.printStackTrace();
                response.processedData = response.data;
            }
        }
        else {
            response.processedData = response.data;
        }
        Response<T> parseNetworkResponseUnpacked = parseNetworkResponseUnpacked(response);
        parseNetworkResponseUnpacked.dataSize = response.data!=null ? response.data.length : 0;
        response.data = null;
     ...
     */
    abstract protected void deliverResponse(Request<T> request, T response,
...
//                right.ordinal() - left.ordinal();
        ...
        return deleteCache ? 10 : (left == right ? this.mSequence - other.mSequence : right
