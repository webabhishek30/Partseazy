...
*/
  ...
  /*@Override
    ...
    public boolean isUpdateMessage() {
        return !ContentType.HIDDEN.getValue().equals(contentType)
                && !MetaDataType.ARCHIVE.getValue().equals(getMetaDataValueForKey(MetaDataType.KEY.getValue()))
    ...
    public boolean isConsideredForCount() {
        return (!ContentType.HIDDEN.getValue().equals(getContentType()) &&
                !ContentType.VIDEO_CALL_NOTIFICATION_MSG.getValue().equals(getContentType()) && !isReadStatus() && !isHidden());
    }

    public boolean isHidden() {
        return GroupMessageMetaData.TRUE.getValue().equals(getMetaDataValueForKey(GroupMessageMetaData.HIDE_KEY.getValue())) || ContentType.HIDDEN.getValue().equals(getContentType());
    }
