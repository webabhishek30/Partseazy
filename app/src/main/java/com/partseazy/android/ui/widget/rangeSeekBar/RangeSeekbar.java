package com.partseazy.android.ui.widget.rangeSeekBar;
...
public class RangeSeekbar extends View {
    ...
    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_bar_highlight_color, Color.RED);
    }

    protected int getLeftThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_left_thumb_color, Color.RED);
    }

    protected int getRightThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_right_thumb_color, Color.RED);
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        // setup seek bar isActive range line
