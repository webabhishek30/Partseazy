...
import com.partseazy.android.ui.model.myorders.OrderLine;
...
public class SubOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SubOrderAdapter(Context context, List<OrderLine> orderLineList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SubOrderViewHolder(mInflater.inflate(R.layout.row_sub_order_card_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        subOrderViewHolder.productNameTV.setText(orderLineData.productInfo.name + "(" + orderLineData.productInfo.summary + ")");
        ...
        subOrderViewHolder.orderLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BaseFragment orderSummaryFragment = OrderSummaryFragment.newInstance(orderLineData.subOdin);
